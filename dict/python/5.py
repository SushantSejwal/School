...
# output
# The Dictionary Class is empty. do wanna enter students data in that, type yes[y] to enter or no[n] to leave
#  =>  y

# Enter the name of student
#  =>  Sushant
# Enter the roll number of Sushant
#  =>  34      
# Enter marks of Sushant out of 100
#  =>  99

# Do wanna enter more students data in Dictionary Class, type yes[y] to enter or no[n] to leave
#  =>  y

# Enter the name of student
#  =>  Programiz
# Enter the roll number of Programiz
#  =>  35
# Enter marks of Programiz out of 100
#  =>  100
...
# Enter the name of student
#  =>  Jinex
# Enter the roll number of Jinex
#  =>  35
# Enter marks of Jinex out of 100
#  =>  100

# Do wanna enter more students data in Dictionary Class, type yes[y] to enter or no[n] to leave
#  =>  n

# Students who get marks above 75 are :
#  Name - Sushant, marks - 99
#  Name - Programiz, marks - 100
#  Name - Jinex, marks - 100