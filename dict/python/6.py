# Write a Python Program to Create a dictionary of employee information (empid, empname,empsal,empmobile), 
# input five values from the user and display the employee who is getting salary less than or equal to Rs. 50000.
...
# Output
# Employee Information dictionary is empty. If you want to add information then type yes[y] or type no[N] to leave
#  =>  y
...
# No one has a Salary equal or less than 50K